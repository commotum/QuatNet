...
$\boldsymbol{s}_j=\sum_i \frac{\boldsymbol{w}_{j i} \boldsymbol{x}_i \overline{\boldsymbol{w}}_{j i}}{\left|\boldsymbol{w}_{j i}\right|}-\boldsymbol{\theta}_j, \quad \boldsymbol{y}_j=f\left(\boldsymbol{s}_j\right)$
