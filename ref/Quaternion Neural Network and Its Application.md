...
$$
\begin{aligned}
& \boldsymbol{s}_{j}=\sum_i \frac{\boldsymbol{w}_{j i} \boldsymbol{x}_i \overline{\boldsymbol{w}}_{j i}}{\left|\boldsymbol{w}_{j i}}\right|}-\boldsymbol{\theta}_{\boldsymbol{j}} &\qquad \qquad (11) \\
& \boldsymbol{y}_{\boldsymbol{j}}=f\left(\boldsymbol{s}_{j}\right) &\qquad \qquad (12)
\end{aligned}
$$
