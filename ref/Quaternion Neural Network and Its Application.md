...
$$\begin{aligned} & \boldsymbol{i}^2^2=\boldsymbol{j}^2=\boldsymbol{k}^2=\boldsymbol{i} \boldsymbol{j} \boldsymbol{k}=-1 \\ & \boldsymbol{i} \boldsymbol{j}=-\boldsymbol{j} \boldsymbol{i}=\boldsymbol{k}, \quad \boldsymbol{j} \boldsymbol{k}=-\boldsymbol{k} \boldsymbol{j}=\boldsymbol{i}, \quad \boldsymbol{k} \boldsymbol{i}=-\boldsymbol{i} \boldsymbol{k}=\boldsymbol{j}\end{aligned}$$