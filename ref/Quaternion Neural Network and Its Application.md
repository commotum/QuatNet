...
$$
\boldsymbol{s}_{j}= \sum_i \frac{\boldsymbol{w}_{ji}\,\boldsymbol{x}_i\,\overline{\boldsymbol{w}}_{ji}}{\lvert \boldsymbol{w}_{ji}\rvert}-\boldsymbol{\theta}_{j}
$$

$$
\boldsymbol{y}_{j}=f\!\bigl(\boldsymbol{s}_{j}\bigr)
$$
