...
$$
\begin{aligned}& \boldsymbol{s}_{j}=\sum_i \frac{\boldsymbol{w}_{ji} \boldsymbol{x}_i \overline{\boldsymbol{w}}_{ji}}{\left|\boldsymbol{w}_{ji}\right|}-\boldsymbol{\theta}_{j} &\qquad \qquad (11) \\& \boldsymbol{y}_{j}=f\left(\boldsymbol{s}_{j}\right) &\qquad \qquad (12)\end{aligned}
$$
