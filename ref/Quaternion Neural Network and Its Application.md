...
$$
\begin{aligned}
& \boldsymbol{s}_{\boldsymbol{j}}= \frac{\boldsymbol{w}_{j i} \boldsymbol{x}_i \overline{\boldsymbol{w}}_{j i}}{\left|\boldsymbol{w}_{\boldsymbol{j} \boldsymbol{i}}\right|}-\boldsymbol{\theta}_{\boldsymbol{j}} \qquad \qquad (11) \\
